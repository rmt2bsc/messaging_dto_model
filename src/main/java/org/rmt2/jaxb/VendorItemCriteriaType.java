 ...
 *         &lt;element name="item_id_list" type="{http://www.w3.org/2001/XMLSchema}integer" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "item_id_list")
    protected List<BigInteger> itemIdList;
     ...
     * 
     */
    public List<BigInteger> getItemIdList() {
        if (itemIdList == null) {
            itemIdList = new ArrayList<BigInteger>();
        }

    ...
    implements Serializable
{
    ...
    @XmlElement(name = "EmployeeType", nillable = true)
    protected List<EmployeetypeType> employeeType;
    @XmlElement(name = "EmployeeTitle", nillable = true)
    ...
    @XmlElement(name = "EmployeeProject", nillable = true)
    protected List<EmployeeProjectType> employeeProject;
    @XmlElement(name = "TimesheetStatus", nillable = true)
    protected List<TimesheetStatusType> timesheetStatus;
    @XmlElement(name = "TimesheetStatusHistory", nillable = true)
    ...
    @XmlElement(name = "ProjectTask", nillable = true)
    protected List<ProjectTaskType> projectTask;
    @XmlElement(name = "TimeLog", nillable = true)
    protected List<EventType> timeLog;
    @XmlElement(name = "ProjectPeriod", nillable = true)

 ...
 *         &lt;element name="status" type="{}item_master_status_type" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<ItemMasterStatusType> status;
     ...
     * 
     */
    public List<ItemMasterStatusType> getStatus() {
        if (status == null) {
            status = new ArrayList<ItemMasterStatusType>();
        }
        return this.status;
    }

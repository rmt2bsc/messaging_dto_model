...
public class ApiTransactionCodes {
    ...
    public static final String ACCOUNTING_CASHDISBURSE_CREDITOR_REVERSE = "REVERSE_CASH_DISBURSEMENT_CREDITOR";
    ...
    public static final String PROJTRACK_CLIENT_DELETE = "DELETE_CLIENT";
    ...
    public static final String MEDIA_LOOKUP_VALUES_GET = "GET_LOOKUP_VALUES";
    ...
    public static final String AUTH_RESOURCE_SUB_TYPE_DELETE = "DELETE_RESOURCE_SUB_TYPE";
    public static final String AUTH_RESOURCE_UPDATE = "UPDATE_RESOURCE";
    public static final String AUTH_RESOURCE_GET = "GET_RESOURCE";
    ...
    public static final String AUTH_APP_ROLE_DELETE = "DELETE_APP_ROLE";
    public static final String AUTH_USER_UPDATE = "UPDATE_USER";
    ...
    public static final String AUTH_CHANGE_PASSWORD = "CHANGE_PASSWORD";

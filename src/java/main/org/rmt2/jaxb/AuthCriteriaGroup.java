    ...
    implements Serializable
{
    ...
    @XmlElement(name = "user_profile_criteria", required = true, nillable = true)
    protected UserProfileCriteriaType userProfileCriteria;
    @XmlElement(name = "user_app_roles_criteria", required = true, nillable = true)
    protected UserAppRolesCriteriaType userAppRolesCriteria;
    @XmlElement(name = "resource_criteria", required = true, nillable = true)
    protected ResourceCriteriaType resourceCriteria;
    @XmlElement(name = "resource_subtype_criteria", required = true, nillable = true)
    protected ResourceSubtypeCriteriaType resourceSubtypeCriteria;
    @XmlElement(name = "user_resource_access_criteria", required = true, nillable = true)

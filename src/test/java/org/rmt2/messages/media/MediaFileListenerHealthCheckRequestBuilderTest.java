...
public class MediaFileListenerHealthCheckRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withModule(ApiTransactionCodes.MODULE_MEDIA_LISTENER)
        ...
        Assert.assertTrue(xml.contains(ApiTransactionCodes.MEDIA_FILE_LISTENER_HEALTH));
    }

...
public class ClientImportRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        ClientType client1 = ClientTypeBuilder.Builder.create()
                .withClientId(100)
                .build();
        ClientType client2 = ClientTypeBuilder.Builder.create()
                .withClientId(200)
                .build();
        ClientType client3 = ClientTypeBuilder.Builder.create()
                .withClientId(300)
                .build();

        ProjectDetailGroup pdg = fact.createProjectDetailGroup();
        pdg.getClient().add(client1);
        pdg.getClient().add(client2);
        pdg.getClient().add(client3);
        req.setProfile(pdg);
        req.setHeader(head);
        ...
        Assert.assertTrue(xml.contains(ApiTransactionCodes.PROJTRACK_CLIENT_IMPORT));
    }
    ...
    public void testBuildResponse() {
        ...
        ReplyStatusType rst = ReplyStatusTypeBuilder.Builder.create()
                ...
                .withMessage("Client imported successfully")
                .withDetailMessage("The following customers/business contacts where imported to Project Tracker as clients: 100, 200, 300" )
                .withRecordCount(3)
                .build();
        ...
        BusinessType bt2 = BusinessTypeBuilder.Builder.create()
                .withBusinessId(222)
                .build();

        CustomerType customer2 = CustomerTypeBuilder.Builder.create()
                .withAccountNo("111-222-222")
                .withCustomerId(5555)
                .withBusinessType(bt2)
                .build();
        ClientType client2 = ClientTypeBuilder.Builder.create()
                .withClientId(200)
                .withClientName("ProjectTracker Client Name 2")
                .withCustomerData(customer2)
                .build();
        
        BusinessType bt3 = BusinessTypeBuilder.Builder.create()
                .withBusinessId(333)
                .build();

        CustomerType customer3 = CustomerTypeBuilder.Builder.create()
                .withAccountNo("111-222-333")
                .withCustomerId(6666)
                .withBusinessType(bt3)
                .build();
        ClientType client3 = ClientTypeBuilder.Builder.create()
                .withClientId(300)
                .withClientName("ProjectTracker Client Name 3")

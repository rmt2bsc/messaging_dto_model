...
public class CreditorPurchseReverseRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withTransaction(ApiTransactionCodes.ACCOUNTING_CREDITPURCHASE_REVERSE)
        ...
        xt.setXactType(XacttypeTypeBuilder.Builder.create().withXactTypeId(120).build());
        xt.setXactAmount(BigDecimal.valueOf(100.00));
        xt.setXactDate(RMT2Date.toXmlDate("2018-12-01"));
        xt.setXactReason("Test creating a creditor purchases transaction via message handler");
        ...
        Assert.assertTrue(xml.contains(ApiTransactionCodes.ACCOUNTING_CREDITPURCHASE_REVERSE));
    }
  }
